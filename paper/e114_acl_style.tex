...
class manifests, checksums, plots, and the source journals) are maintained as a
paper-scoped artifact bundle under the MIT License, covering the held-out
...
(\textasciitilde1.2\,GB) are available for verification, with
...
This work was self-funded. Language-model tools were used for drafting
